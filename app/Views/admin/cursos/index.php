                    ...
                    <tbody class="dashboard-table__tbody">
                        ...
                        <?php if(count($courses) > 0): ?>
                            ...
                            <?php foreach($courses as $course): ?>
                                <tr>
                                    <td><a href="/curso/view/<?=$course->url?>"  target="_blank"><img class="dashboard-table__photo--square" src="/assets/thumbnails/<?=$course->thumbnail?>" alt="foto <?=$course->thumbnail?>"></a></td>
                                    <td><?=$course->name?></td>
