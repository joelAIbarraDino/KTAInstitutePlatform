...
<main class="main">
    <div class="main__container">
        ...
        <form class="form form-admin" enctype="multipart/form-data" method="post">
            <legend class="form__title">Actualizar gif</legend>
            
            <p class="form__instructions">Completa los campos para actualizar el gif</p>
            <?php include_once __DIR__.'/../../components/alerts.php'; ?>
            
            <?php include_once __DIR__.'/form.php'; ?>

            <div class="submit-right">
                <input id="new-teacher-btn" class="submit" type="submit" value="Actualizar gif">
            </div>
